...
Possible types are: Incoming, Outgoing, External, Internal and FALoop[n]."
...
FALoop::usage =
"Propagator[FALoop[n]][...] denotes a propagator on loop n."
...
on a propagator of type t (External, Internal, FALoop)."
...
FASI::usage = "FASI[n] is the nth summation index in a component of the
kinematic vector."
...
particle p running on a propagator of type t (External, Internal, FALoop). 
...
FAFeynAmpList) of all insertions of Topology or TopologyList tops."
...
obtained by GaugeRules -> {_FAGaugeXi -> 1}."
...
FAFeynAmp::usage =
"FAFeynAmp is the head of a data structure that represents the analytical
...
FAFeynAmpList::usage =
"FAFeynAmpList is the head of a list of FeynAmps."

GraphID::usage =
"GraphID is the head of a data structure identifying a single FAFeynAmp in
a FAFeynAmpList."

Integral::usage =
"Integral[q] is a member of a FAFeynAmp data structure and contains the
...
FAPropagatorDenominator::usage =
"FAPropagatorDenominator[p, m] stands for the expression 1/(p^2 - m^2)
that is contained in internal propagators of a Feynman graph. 
FAPropagatorDenominator[p, m, d] is the denominator raised to the
power d."

FAFeynAmpDenominator::usage =
"FAFeynAmpDenominator[d1, d2, ...] contains the PropagatorDenominators 
d1, d2, ... that belong to a loop."

FAGaugeXi::usage =
"FAGaugeXi[s] is a gauge parameter with index s."
...
FANonCommutative::usage =
"FANonCommutative is the head of noncommuting objects in a Feynman rule."

FALeviCivita::usage =
"FALeviCivita[mu, nu, ro, si] represents -I times the antisymmetric
...
symbols with head FANonCommutative in the Feynman rules) in closed fermion
loops."

FermionChain::usage =
"FermionChain is the head of a trace of noncommuting objects (i.e. of
symbols with head FANonCommutative in the Feynman rules) in open fermion
chains."
...
P$InsertionObjects = G[_][_][__][__] | _Mass |
  _FAGaugeXi | _GaugeVector | VertexFunction[_][__]
...
Print["(patched for use with FeynCalc) by Hagen Eck, Sepp Kueblbeck, and Thomas Hahn"];
