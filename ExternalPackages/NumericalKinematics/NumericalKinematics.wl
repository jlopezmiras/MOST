  		...
  		While[
   		...
   		duals = (*the masses*)
    		...
    		If[OptionValue[FiniteFields],duals=toFF@duals];
    		 ...
    		 Print[massive];
    		 Print[masses];*)
    		 aaaaa=Table[masses[[2]][[ccc]]->ccc^2,{ccc,1,Length[masses[[2]]]}];
    		 (*Print[aaaaa];*)
    		 twistors=Table[If[(duals[[i]]/.aaaaa)==0,twistors[[i]],{twistors[[i,1]],twistors[[i,2]]*Sqrt[duals[[i]]]/(NumericalKinematics`Private`TwoBracket[Sequence@@twistors[[i]]])}],{i,Length@duals}]//Simplify;
(*Print[twistors];*)
